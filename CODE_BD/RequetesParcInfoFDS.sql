...
/* Afficher la liste des ordinateurs a renouveler (i.e en fin de garantie ou arrivant en fin de garantie avant l’année prochaine) */
SELECT NumSerie
FROM Ordinateur O1,Commande
...
/*  Afficher les ordinateurs sans etiquetes c-à-d sans NumInventaire  */
